    ...
    <div class="mt-8 border-t">
      <footer class="m-auto flex flex-wrap items-center justify-between p-3">
        <div class="container mx-auto flex flex-col flex-wrap items-center justify-between">
          <ul class="mx-auto flex text-center">
            <li class="cursor-pointer p-2 hover:underline">Terms & Conditions</li>
            <li class="cursor-pointer p-2 hover:underline">Privacy</li>
            <li class="cursor-pointer p-2 hover:underline">Cookies</li>
          </ul>
          <ul class="mx-auto flex text-center">
