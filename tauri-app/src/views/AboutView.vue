<template>
    <div class="mx-auto max-w-screen-xl">
      <main class="mt-10">
        <div class="relative mx-auto mb-4 w-full max-w-screen-md md:mb-0" style="height: 24em">
          <div
          ...
          <div class="absolute bottom-0 left-0 z-20 p-4 sm:bottom-4">
            <h2 class="text-xl font-semibold leading-tight text-gray-100 sm:text-4xl">
              Pellentesque a consectetur velit, ac molestie ipsum.
            </h2>
          </div>
        </div>
  
        <div class="mx-auto mt-12 max-w-screen-md px-4 text-lg leading-relaxed text-gray-700 lg:px-0">
          <p class="pb-6">
            Advantage old had otherwise sincerity dependent additions. It in adapted natural hastily
            is justice. Six draw you him full not mean evil. Prepare garrets it expense windows
            shewing do an. She projection advantages resolution son indulgence. Part sure on no long
            life am at ever. In songs above he as drawn to. Gay was outlived peculiar rendered led
            six.
          </p>
  
          <p class="pb-6">
            Difficulty on insensible reasonable in. From as went he they. Preference themselves me as
            thoroughly partiality considered on in estimating. Middletons acceptance discovered
          ...
          <p class="pb-6">
            ...
            Warmth object matter course active law spring six. Pursuit showing tedious unknown winding
            see had man add. And park eyes too more him. Simple excuse active had son wholly coming
            number add. Though all excuse ladies rather regard assure yet. If feelings so prospect no
          ...
          <p class="pb-6">
            ...
            defective at. Sympathize interested simplicity at do projecting increasing terminated. As
            edward settle limits at in.
          </p>
  
          <p class="pb-6">
            Dashwood contempt on mr unlocked resolved provided of of. Stanhill wondered it it welcomed
            oh. Hundred no prudent he however smiling at an offence. If earnestly extremity he he
            propriety something admitting convinced ye. Pleasant in to although as if differed
          ...
          <p class="pb-6">
            ...
            at tastes really so cousin am of. Extensive therefore supported by extremity of contented.
            Is pursuit compact demesne invited elderly be. View him she roof tell her case has sigh.
            Moreover is possible he admitted sociable concerns. By in cold no less been sent hard
            hill.
          </p>
          ...
          <p class="pb-6">
            ...
            instrument am. Indulgence contrasted sufficient to unpleasant in in insensible favourable.
